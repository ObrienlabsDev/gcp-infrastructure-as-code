...
| source_image | The image name for the disk for the VM instance. | `string` | `"projects/nvidia-vgpu-public/global/images/nv-windows-server-2022-vws-581-42-v202510290321"` | no |
...
| boot_disk_size | The boot disk size for the VM instance in GBs | `number` | `50` | no |
